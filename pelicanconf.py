...
CONFERENCES = [
    ...
    ("2016 Reformation Conference", "Evangelism and Christian Worldview", "Speakers: Allen Curry and Andrew Hoffecker",
     "Dr. Allen Curry on Evangelism and Dr. Andrew Hoffecker on Building a Christian Worldview. Sessions on Friday evening starting at 6:30 PM and Saturday morning at 9 AM. Sunday morning worship and Sunday school with both men.", "http://www.sermonaudio.com/search.asp?seriesOnly=true&currSection=sermonstopic&sourceid=shiloh&keyword=Reformation+Conference+2016&keyworddesc=Reformation+Conference+2016", "PLXqNhbObfqJo4OsxysaOUw1BVMgkPPFfW"),
