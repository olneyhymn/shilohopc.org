...
OFFICERS = [("Matthew Holst", "matthew.holst@shilohopc.org", "Matthew Holst served as pastor of Geneva Orthodox Presbyterian Church in Marietta, Georgia from 2010 to 2016; before that he ministered in Cambridge Presbyterian Church (UK) for one year. Matt is a 2008 graduate of Greenville Presbyterian Theological Seminary. His wife, Stacy is a native of Greenville SC and together they have four children. He was installed as senior pastor of Shiloh in June 2016. ", "Pastor", 'holst'),
            ("Irfon Hughes", "irfon.hughes@shilohopc.org",
             "Irfon and Ann Hughes and their 5 children came to the USA in 1984. He is a Welsh speaking Welsh American. They have been married for 47 years and have 16 grandchildren. Irfon pastored 2 congregations in Massachusetts and Western Pennsylvania, and retired from full time ministry in 2008. In his retirement, he served as an assistant pastor in Providence PCA in Fayetteville NC and associate pastor at Shiloh. He retired as a pastor of Shiloh in May 2017 but remains a member of the Session. He still loves to preach, read History, historical theology, supports missionary endeavor and pastoral studies, and plays golf, in that order. He is getting ever closer to meeting his Lord and looks forward to that.", "Pastor - retired", 'hughes'),
...
CONFERENCES = [
    ("2016 Missions Conference",
     ...
     "Church planters Nick Batzig and Eric Hausler speak on evangelism, outreach, and planting reformed churches.",
     "http://www.sermonaudio.com/search.asp?seriesOnly=true&currSection=sermonstopic&sourceid=shiloh&keyword=2017+Missions+Conference&keyworddesc=2017+Missions+Conference",
     "PLXqNhbObfqJplSzYWIsMC2UxLkQWpuV6h"),
    ("2016 Reformation Conference",
     "Evangelism and Christian Worldview",
     "Speakers: Allen Curry and Andrew Hoffecker",
     "Dr. Allen Curry on Evangelism and Dr. Andrew Hoffecker on Building a Christian Worldview. Sessions on Friday evening starting at 6:30 PM and Saturday morning at 9 AM. Sunday morning worship and Sunday school with both men.",
     "http://www.sermonaudio.com/search.asp?seriesOnly=true&currSection=sermonstopic&sourceid=shiloh&keyword=Reformation+Conference+2016&keyworddesc=Reformation+Conference+2016",
     "PLXqNhbObfqJo4OsxysaOUw1BVMgkPPFfW"),
    ("2015 Reformation Conference",
     "Solas of the Reformation",
     "Speaker: Dr. Joey Pipa",
     "Dr. Joey Pipa, president of Greenville Presbyterian Theological Seminary, taught through the solas of the Reformation.",
     "http://www.sermonaudio.com/search.asp?sourceonly=true&currSection=sermonssource&keyword=shiloh&subsetcat=series&subsetitem=Reformation+Conference+2015"),
    ("2014 Reformation Conference with truthXchange",
     "Tell the Truth: Christian Witness in a Pagan Planet",
     "Speakers: Dr. Peter Jones, Dr. Calvin Beisner, Dr. Joe Boot, Mrs. Pamela Frost, and Dr. Thaddeus Williams",
     ...
     "http://www.sermonaudio.com/search.asp?seriesOnly=true&currSection=sermonstopic&sourceid=shiloh&keyword=Reformation+Conference+2014&keyworddesc=Reformation+Conference+2014"),
    ("2013 Reformation Conference",
     ...
     "http://www.sermonaudio.com/search.asp?seriesOnly=true&currSection=sermonstopic&sourceid=shiloh&keyword=Reformation+Conference+2013&keyworddesc=Reformation+Conference+2013"),
    ("2013 Men's Conference",
     "The Masculine Mandate",
     "Speakers: Dr. Rick Phillips",
     ...
     "http://www.sermonaudio.com/search.asp?sourceonly=true&currSection=sermonssource&keyword=shiloh&keywordDesc=&subsetcat=series&subsetitem=The+Masculine+Mandate"),
    ("2012 Reformation Conference",
     "Science, Evil, and the Environment: Answering Contemporary Challenges to the Christian Faith",
     "Speakers: Scott Oliphint and James Wanlinss",
     ...
     "http://www.sermonaudio.com/search.asp?sourceonly=true&currSection=sermonssource&keyword=shiloh&keywordDesc=&subsetcat=series&subsetitem=Reformation+Conference+2012"),
]
